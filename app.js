    ...
    tournaments: [
        {
            ...
            prize: "$1,250,000",
            dates: "06.04 - 13.04.2025",
            location: "Бухарест, Румыния",
            bets: [
                { option: "Европейский чемпион", odds: 2.50 },
                { option: "Турнирный MVP из топ-4", odds: 1.90 },
                { option: "Финал > 3 карты", odds: 2.10 }
            ]
        },
        {
            id: 2,
            name: "IEM Melbourne 2025",
            prize: "$1,000,000",
            dates: "21.04 - 27.04.2025",
            location: "Мельбурн, Австралия",
            bets: [
                { option: "Азиатская команда в топ-4", odds: 3.80 },
                { option: "Приз зрительских симпатий", odds: 4.20 },
                { option: "Обе карты финала > 25 раундов", odds: 2.30 }
            ]
        },
        {
            id: 3,
            ...
            prize: "$1,250,000",
            dates: "10.05 - 18.05.2025",
            location: "Астана, Казахстан",
            bets: [
                { option: "Победитель из СНГ", odds: 2.20 },
                { option: "Хет-трик в финале", odds: 3.50 },
                { option: "Более 2.5 карт в полуфиналах", odds: 1.95 }
            ]
        },
        {
            id: 4,
            ...
            prize: "$1,000,000",
            dates: "19.05 - 25.05.2025",
            location: "Даллас, США",
            bets: [
                { option: "Американская команда в финале", odds: 3.20 },
                { option: "Средний рейтинг > 1.5", odds: 2.60 },
                { option: "Количество карт турнира > 50", odds: 2.00 }
            ]
        }
    ],
    matches: [] // Пустой массив, так как матчи не нужны
};
};
